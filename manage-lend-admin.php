...
<body>
  ...
  <!-- Page Content -->
    ...
    <div class="jumbotron">       
      <div class="row">
        <div class="col-lg-12 ">
         <h2 class="display-5 text-center">การจัดการข้อมูลการเช่า</h2>
         <br>
            ...
            <table id="example" class="table table-hover table-bordered table-dark" cellspacing="0" width="100%">
              <thead class="thead-light">
                <tr class="table-active">
                  ...
                  <th width="30%">ยูสเซอร์/ชื่อผู้ยืม</th>
                  ...
                  <tr>
                    ...
                    <td >
                      <label class="custom-control custom-checkbox">
                        ...
                        <a href="<?=$book[$i]->book_detail != '' ? $book[$i]->book_detail : '#';?>" target="_blank"><?=$book[$i]->book_detail != '' ? ' ->(รูปอุปกรณ์)' : '';?></a>
                      </label>
                    </td>
                    <td>
