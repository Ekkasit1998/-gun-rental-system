...
<div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">ระบบเช่าปืน สนามยิงปืน</a>
    ...
    <!-- Admin -->
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item <?=$active_return?>">
            <a class="nav-link" href="manage-lend-admin.php">จัดการการเช่า</a>
          </li>
          <li class="nav-item <?=$active_lend?>">
              <a class="nav-link" href="lend.php">จัดการข้อมูลอุปกรณ์</a>
            </li>
          <li class="nav-item <?=$active_book?>">
            <a class="nav-link" href="book.php">เพิ่มอุปกรณ์ใหม่</a>
          </li>
          <li class="nav-item <?=$active_admin?>">
            <a class="nav-link" href="logout.php">ออกจากระบบ</a>
          </li>
